...
public:
	...
	void InsertBefore(PersData value, int index); // вставка элемента перед другим элементом с известным индексом
	void Remove(int index);           // функция удаления элемента с известным индексом
};